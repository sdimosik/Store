...
class DetailProductsWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result = coroutineScope {
        try {
            val f = async(Dispatchers.IO) {
                ...
                if (cacheApi.getCacheProducts() == null || forceRefresh) {
    ...
    @AssistedFactory
    interface Factory {
        fun create(appContext: Context, params: WorkerParameters): DetailProductsWorker
    }
}